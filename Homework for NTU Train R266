---
title: "Homework for NTU Train R266"
author: "Lee An Tser"
---
# Airbnb X Kaggle Analysis Base Table
  
# Read in csv files

setwd("/Users/brian/Desktop/R語言/airbnbAtKaggle/data")

setwd("/Users/brian/Desktop/R語言/NTUTrainRL1/data")

ageSummary <- read.table('/Users/brian/Desktop/R語言/airbnbAtKaggle/data/age_gender_bkts.csv', sep=',', stringsAsFactors=F, header=T)

countriesSummary <- read.table('/Users/brian/Desktop/R語言/airbnbAtKaggle/data/countries.csv', sep=',', stringsAsFactors=F, header=T)

sessions <- read.table('/Users/brian/Desktop/R語言/airbnbAtKaggle/data/sessions.csv', sep=',', stringsAsFactors=T, header=T, nrow= 10000)

trainUsers <- read.table('/Users/brian/Desktop/R語言/airbnbAtKaggle/data/train_users_2.csv', sep=',', stringsAsFactors=T, header=T, nrow= 10000)

testUsers <- read.table('/Users/brian/Desktop/R語言/airbnbAtKaggle/data/test_users.csv', sep=',', stringsAsFactors=T, header=T)

# coded under OSX environment
...
# merge ageSummary and countriesSummary for plotting, left join.
...
sessionsActionType <- 
sqldf(" 
        select user_id, case when action_type=='booking_request' then 'booking_request'
...
sessionsDeviceType <- 
sqldf("
       select user_id,case when device_type=='Android App Unknown Phone/Tablet' 
       then 'android_app_unknown_phone_tablet'
...
train <- read.table('train_v1.csv', sep=',', header=T, colClasses=c("date_account_created"="Date", "timestamp_first_active"="POSIXct", "date_first_booking"="Date", "date_first_active"="Date"), nrows = 10000)

test <- read.table('test_v1.csv', sep=',', header=T, colClasses=c("date_account_created"="Date", "timestamp_first_active"="POSIXct", "date_first_booking"="Date", "date_first_active"="Date"), nrows = 10000)
